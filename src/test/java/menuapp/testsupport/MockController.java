...
public class MockController extends AppController {
    ...
    private void mockSeedMenu() {
        ...
        menuItems.add(new MenuItem("Cumin Lamb Biang-Biang Noodles", 25.5, Category.MAIN, "/images/cumin-lamb-biang-biang-noodles.png"));
        // Dessert
        menuItems.add(new MenuItem("Profiteroles", 7.00, Category.DESSERT, "/images/profiteroles.png"));
        ...
        menuItems.add(new MenuItem("Alžírská káva", 4.56, Category.BEVERAGE, "/images/alzirska-kava.png"));
    ...
    public void saveFavorites(String filePath) {
        ...
        System.out.println("MockController: saved " + favorites.size() + " items to " + filePath);
    }
    ...
    public void loadFavorites(String filePath) {
        ...
        System.out.println("MockController: loaded " + favorites.size() + " items from " + filePath);
    }
    ...
    public void exportLowStock(int threshold, String filePath) {
        ...
        System.out.println("MockController: exported " + lastExportedLowStock.size() + " low stock items to " + filePath);
    }
