...
public class OrderPanel extends AppPanel {
    ...
    public OrderPanel(AppController controller) {
        ...
        this.emptyStateLabel = new JLabel("Your cart is empty. Add something from our menu for checkout!\u263A\uFE0F", SwingConstants.CENTER);
    ...
    private void handleCheckout() {
        ...
        int answer = JOptionPane.showConfirmDialog(this, "Place this order for " + totalLabel.getText() + "?", "Checkout", JOptionPane.YES_NO_OPTION);
